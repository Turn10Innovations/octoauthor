...
_HIGHLIGHT_JS = (
    ...
    "    txt = el.options[el.selectedIndex]?.text || el.getAttribute('title') || '';"
    "  } else if (el.tagName === 'INPUT' || el.tagName === 'TEXTAREA') {"
    "    txt = el.getAttribute('placeholder') || el.getAttribute('title') || '';"
    "  } else {"
    "    txt = el.textContent || el.getAttribute('title') || '';"
    "  }"
